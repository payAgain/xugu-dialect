...
| A-FUN-015 bit_and/bit_or | **not registered** (matrix deferred) |
...
- MINOR: JSON HQL preview flag docs polish (optional to P-010)
...
- Reviewer decision: `approve` (`rev-p006-20260715`)
