...
| A-TYP-014 | Types | INTERVAL | Map Hibernate duration/interval if Dialect exposes | `reference/sql/datatype/datetime.md` | 可实现 | **I-010/P-002** | ✅ **covered-live** — entity ORM path (`XuguIntervalJdbcType` + `intervalEntityOrmRoundTrip_A_TYP_014`) for DURATION/INTERVAL_SECOND; 11 other subtypes tooling-only; covered-live pending live IT; baseline [`production-regression-baseline.md`](production-regression-baseline.md) § A-TYP-014 |
...
| A-TYP-016 | Types | XML | Map SQLXML / XML type | `reference/sql/datatype/xml.md` | 可实现 | **I-010/P-003** | ✅ **covered-live** — entity ORM path (`XuguXmlJdbcType` + `xmlEntityOrmRoundTrip_A_TYP_016`) for `String`+`@JdbcTypeCode(SQLXML)`; `java.sql.SQLXML` not recommended; native IT retained; covered-live pending live IT; baseline § A-TYP-016 |
| A-TYP-017 | Types | Geometric / spatial | Map geometry types | `reference/sql/datatype/geometric.md` | 可实现 | **I-010/P-004** | ✅ **covered-live** — POINT/GEOMETRY→POINT entity ORM (`XuguPointJdbcType` + `pointEntityOrmRoundTrip_A_TYP_017`); LINE/LSEG/BOX/PATH/POLYGON/CIRCLE native/tooling only; simple 2D (not PostGIS); covered-live pending live IT; pair A-FUN-020; baseline [`production-regression-baseline.md`](production-regression-baseline.md) § A-TYP-017 |
...
| A-FUN-005 | Functions | trim / ltrim / rtrim | trim family | `reference/function/string-functions/trim.md`, `ltrim.md`, `rtrim.md` | 可实现 | P-006 / **I-010/P-008** | ✅ **covered-live** — independent HQL Session `trimFamilyHqlSession_A_FUN_005` present; covered-live pending live IT PASS; baseline § A-FUN-005 |
| A-FUN-006 | Functions | replace / locate / position | search/replace | `reference/function/string-functions/replace.md`, `locate.md`, `position.md` | 可实现 | P-006 / **I-010/P-008** | ✅ **covered-live** — independent HQL Session `replaceLocateHqlSession_A_FUN_006` present; covered-live pending live IT PASS; baseline § A-FUN-006 |
| A-FUN-007 | Functions | coalesce / nullif / nvl | null-handling | `reference/sql/expression/function.md` (COALESCE), `reference/function/flow-control-functions/nullif.md`, `reference/function/string-functions/nvl.md`, `reference/function/flow-control-functions/ifnull.md` | 可实现 | P-006 / **I-010/P-008** | ✅ **covered-live** — independent HQL Session `coalesceNvlHqlSession_A_FUN_007` present; covered-live pending live IT PASS; baseline § A-FUN-007 |
...
| A-FUN-009 | Functions | round / floor / ceil / trunc | rounding | `reference/function/mathematical-functions/round.md`, `floor.md`, `ceil.md`, `trunc.md` | 可实现 | P-006 / **I-010/P-008** | ✅ **covered-live** — independent HQL Session `roundTruncHqlSession_A_FUN_009` present; covered-live pending live IT PASS; baseline § A-FUN-009 |
