...
## Goal
- 根据归档旁证 `.trellis/tasks/archive/2026-07/i-002-hql-pagination-sequence-metadata/research/independent-it-2026-07/TEST-REPORT.md`，修复 HQL 分页（ANSI OFFSET/FETCH）与 schema validate 序列元数据缺失；**本仓补充测试用例并验证通过**；制品版本仍为 **`7.4.5.Final`**。
...
- 独立 IT 旁证已归档删除；验收以本仓 gated IT 为准
- 版本号沿用 **`7.4.5.Final`**
...
- [x] （可选证据）独立 IT 旁证 — **N/A / archived**（`.trellis/tasks/archive/2026-07/i-002-hql-pagination-sequence-metadata/research/independent-it-2026-07/`；本仓 IT primary）
...
- Initiative Accept evidence: `(historical harness evidence removed; see Trellis task research/ if present) orchestrator/I-002/ACCEPTANCE.md`
...
- Archive record: `.trellis/tasks/archive/2026-07/ (historical; former harness path) I-002/ARCHIVE.md`
